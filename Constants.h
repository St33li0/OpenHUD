...
// Constants.h
// https://raw.githubusercontent.com/thomas4f/mxbmrp2/refs/heads/master/mxbmrp2/Constants.h
...
// Plugin
inline constexpr const char* PLUGIN_VERSION = "OpenHud_CPP-v0.0.2";
inline constexpr const char* HOST_VERSION = "MX Bikes beta20b";
inline constexpr const char* DATA_DIR = "OpenHud_data";
inline constexpr const char* PROFILE_DIR = "OpenHud";
inline const std::filesystem::path LOG_FILE = "OpenHud.log";
inline const std::filesystem::path CONFIG_FILE = "OpenHud.ini";
inline const std::filesystem::path DAT_FILE = "OpenHud.dat";
inline const std::filesystem::path HTML_FILE = "OpenHud.html";
inline const std::filesystem::path JSON_FILE = "OpenHud.json";
...
// Discord RP (Currently Disabled/Unused)
